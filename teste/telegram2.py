...
chave_api = "6406389382:AAEAk8-xln_KfRnUvAit7AfxfzsHJ5QcX0I"

proxy_url={
    'http': 'http://lucas.timoteo:Caina9018@10.0.0.230:3128/',
    'https': 'http://lucas.timoteo:Caina9018@10.0.0.230:3128/'
}

bot = telebot.TeleBot(chave_api,proxy_url)
