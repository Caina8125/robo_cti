...
def post_arquivos_Norte_hmg():
    ...
    try:
        ...
        telegram.Dev("Erro ao buscar o Token no Auth")
    ...
    for arquivo in lista_ordenada:
        ...
        try:
            ...
            telegram.Dev(f"Erro ao fazer o post na API do censo - CTI_NORTE ")
            time.sleep(1)
        ...
        try:
            ...
            telegram.Dev(f"Ocorreu um erro ao Subir o arquivo {arquivo[1]} para a S3 - CTI_NORTE.")
...
def post_arquivos_Sul_hmg():
    ...
    try:
        ...
        Pidgin.main(f"Olá, ocorreu um erro no robô ao buscar o Token no Auth. {e.__class__.__name__}: {e}")
        telegram.Dev(f"Erro ao buscar o Token no Auth.")
    ...
    for arquivo in lista_ordenada:
        ...
        try:
            ...
            telegram.Dev(f"Erro ao fazer o post na API do censo - CTI_SUL")
            time.sleep(1)
        ...
        try:
            ...
            telegram.Dev(f"Ocorreu um erro ao Subir o arquivo {arquivo[1]} para a S3 - CTI_SUL.")
